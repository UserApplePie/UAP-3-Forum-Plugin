  ...
  class Forum extends Controller{
    ...
    private $forum_topic_reply_limit;
  	...
  	public function __construct(){
  		parent::__construct();
  		$this->model = new \App\Modules\Forum\Models\Forum();
      ...
      if($this->forum_on_off == 'Enabled'){
        Router::any('Forum', 'App\Modules\Forum\Controllers\Forum@forum');
        Router::any('Topics/(:num)', 'App\Modules\Forum\Controllers\Forum@topics');
    		Router::any('Topics/(:num)/(:num)', 'App\Modules\Forum\Controllers\Forum@topics');
